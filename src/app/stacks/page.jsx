                            ...
                            <div className="flex flex-col justify-center p-6 bg-background border border-colorBorder rounded-lg w-full flex-1 h-24">
                              <div className="flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                  ...
                                  <p className="opacity-60 text-xs">
                                    JavaScript is a versatile language for web
                                    development.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="flex flex-col justify-center p-6 bg-background border border-colorBorder rounded-lg w-full flex-1 h-24">
                              <div className="flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                  ...
                                  <p className="opacity-60 text-xs">
                                    TailwindCSS is a utility-first CSS
                                    framework.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="flex flex-col justify-center p-6 bg-background border border-colorBorder rounded-lg w-full flex-1 h-24">
                              <div className="flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                  ...
                                  <p className="opacity-60 text-xs">
                                    Node.js is a fast, server-side JavaScript
                                    runtime.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="flex flex-col justify-center p-6 bg-background border border-colorBorder rounded-lg w-full flex-1 h-24">
                              <div className="flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                  ...
                                  <p className="opacity-60 text-xs">
                                    MongoDB is a NoSQL database with JSON-like
                                    documents.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="flex flex-col justify-center p-6 bg-background border border-colorBorder rounded-lg w-full flex-1 h-24">
                              <div className="flex gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                  ...
                                  <p className="opacity-60 text-xs">
                                    Python is a simple, versatile programming
                                    language.
                                  </p>
                                </div>
                              </div>
