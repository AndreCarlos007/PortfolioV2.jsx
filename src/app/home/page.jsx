            ...
            <span className="" style={{ opacity: 1, transform: "none" }}>
              ...
              >
                ...
                <div className="flex gap-1 items-center ">
                  ...
                  <p
                    translate="no"
                    className="md:text-4xl text-lg font-semibold  text-pretty"
                  >
                    Full-Stack.
                  </p>
                </div>
                ...
                <p className="opacity-60 mt-6 text-justify ">
                  ...
                  This portfolio showcases a variety of projects that
                  demonstrate my expertise in diverse technologies and
              ...
              >
                <div className="flex items-center gap-2 mt-0">
                  ...
                  <Link href="/send-email">
                    <button
                      translate="no"
                      className="inline-flex items-center justify-center rounded-md text-white/60 hover:text-white font-medium transition-colors  border border-colorBorder hover:bg-colorBorder text-xs px-[8px] py-[6px] gap-2"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="12"
                  ...
                  <Image
                    className=" w-12 sm:w-[80px] pointer-events-none"
                    src="/horse.AVIF"
